  ...
  <div class="pozadina">
    <div class="login">
      ...
      <form v-if="i==2">
        ...
        <div class="form-group">
          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="How old are you?">
        </div>
        <div class="form-group">
          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Country">
        </div>
        <div class="form-group">
      ...
      <form v-if="i==3">
        <div class="form-group">
          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Job category">
        </div>
        <div class="form-group">
          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Job description">
        </div>
        <router-link to="/Naslovna"><button type="submit" class="btn btn primary">Sign up</button></router-link>
      </form>
    </div>
  </div>    
</template>
